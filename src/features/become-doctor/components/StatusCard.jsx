const STATUS_CONFIG = {
  ...
  VERIFIED: {
    ...
    border: '#86efac',
    iconBg: '#d1fae5',
    title: 'Compte médecin vérifié',
    description:
      'Félicitations ! Votre compte médecin a été vérifié. Vous pouvez maintenant accéder à toutes les fonctionnalités réservées aux médecins.',
