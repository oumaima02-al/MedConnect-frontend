    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <div style={{
        ...
        <p style={{ fontSize: '0.82rem', color: '#92400e', lineHeight: 1.5 }}>
          Veuillez téléverser les deux faces de votre carte professionnelle. Les images doivent être <strong>claires et lisibles</strong>.
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 20 }}>
        <UploadCard
          id="bd-doc-front"
          label="Recto de la carte professionnelle"
          side="FRONT"
        ...
        <UploadCard
          id="bd-doc-back"
          label="Verso de la carte professionnelle"
          side="BACK"
